...
export class RelationComponent implements OnInit {
  ...
  public nomRelationSansEspace : any;
  ...
  hide(){
    if(this.cacher){
      $('.'+this.nomRelationSansEspace).css("display", "contents");
      this.cacherOuPas = "Cacher";
      this.cacher = false;
    }else{
      $('.'+this.nomRelationSansEspace).css("display", "none");
  ...
  ngOnInit() {
    let tempo = this.nomRelation;
    this.nomRelationSansEspace = tempo.replace(/\s/g,"-");
    this.nomRelationSansEspace = this.nomRelationSansEspace.replace("'","-");
    this.nomRelationSansEspace = this.nomRelationSansEspace.replace("->","-");
  }
